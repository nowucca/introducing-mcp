...
time_tool = Tool(
    ...
    inputSchema={
        ...
        "properties": {
            "format": {
                "type": "string",
                "description": "Time format string (optional)"
            }
        }
    }
)
                    ...
                    if "id" in data:
                        ...
                        if request.method == "initialize":
                            ...
                            if tool_name == "get_time":
                                # Get the format string if provided, otherwise use default
                                time_format = arguments.get("format", "%H:%M:%S")
