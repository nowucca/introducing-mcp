...
def fill_args_if_missing(tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with websockets.connect(uri) as websocket:
            ...
            init_request = {
                ...
                "params": {
                    ...
                    "clientInfo": {
                        "name": "MCP Multiple Tools WebSocket Client",
                        "version": "0.1.0"
                    },
                    "capabilities": {
                        "tools": {
            ...
            try:
                ...
                system_message = """You are a helpful assistant that provides information about time and weather.
When asked about the time, use the get_time tool, even if no timezone is specified.
When asked about the weather, use the get_weather tool with the city parameter.
The client will automatically fill in any missing parameters."""
                ...
                if completion.choices[0].message.tool_calls:
                    ...
                    for tool_call in completion.choices[0].message.tool_calls:
                        ...
                        try:
                            ...
                            # Fill in missing arguments from memory
                            filled_args = fill_args_if_missing(tool_name, original_args)
...
def main():
    ...
    try:
        ...
        logger.info("Starting MCP Multiple Tools WebSocket client")
