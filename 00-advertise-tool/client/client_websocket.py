...
async def connect_to_server():
    """Connect to the MCP server and interact using websockets"""
    ...
    try:
        async with websockets.connect(uri) as websocket:
            ...
            init_request = {
                ...
                "params": {
                    ...
                    "clientInfo": {
                        "name": "Simple MCP WebSocket Client",
                        "version": "0.1.0"
                    },
                    "capabilities": {
                        "tools": {
            ...
            # Proactively request the tools list as part of standard initialization
            # This happens regardless of whether we receive a tools/list_changed notification
            logger.info("Proactively requesting tool list after initialization")
            list_tools_request = {
                "jsonrpc": "2.0",
                "id": str(uuid.uuid4()),
                "method": "tools/list",
            ...
            # MCP protocol exchange completed
        ...
        logger.debug(f"Traceback: {asyncio.format_exc()}")
